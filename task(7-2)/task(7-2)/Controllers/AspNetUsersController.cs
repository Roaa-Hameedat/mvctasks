...
using task_7_2_.Models;

namespace task_7_2_.Controllers
{
    public class AspNetUsersController : Controller
    {
        private fortaskfourEntities db = new fortaskfourEntities();
        ...
        public ActionResult Index()
        {
            ...
            return View(user.Where(x=>x.Email== "bushra@gmail.com").ToList());
        }
